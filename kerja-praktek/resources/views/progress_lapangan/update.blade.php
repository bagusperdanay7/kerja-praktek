            ...
            <form action="{{ route('progress.update', $progress->id) }}" method="POST">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea name="alamat_toko" id="alamat_toko" rows="3" class="form-control">{{ $progress->alamat_toko }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_order_pt1" id="tanggal_order_pt1" class="form-control" value="{{ $progress->tanggal_order_pt1 }}">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan_pt1" id="keterangan_pt1" rows="1">{{ $progress->keterangan_pt1 }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_order_pt2" id="tanggal_order_pt2" class="form-control" value="{{ $progress->tanggal_order_pt1 }}">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan_pt2" id="keterangan_pt2" rows="1">{{ $progress->keterangan_pt1 }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="datek_odp" id="datek_odp" class="form-control" value="{{ $progress->datek_odp }}">
                </div>
                <div class="form-group">
                    <label for="datek_gpon">Datek GPON</label>
                    <input type="text" name="datek_gpon" id="datek_gpon" class="form-control" value="{{ $progress->datek_gpon }}">
                </div>
                <div class="form-group">
                    <label for="keterangan">Keterangan</label>
                    <textarea name="keterangan" id="keterangan" rows="2" class="form-control">{{ $progress->keterangan }}</textarea>
                </div>
